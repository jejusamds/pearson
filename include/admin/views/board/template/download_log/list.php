                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?= $rowNo ?></td>
                                    <td><span class="ellipsis"><?= $row['first_name'] ?></span></td>
                                    <td><span class="ellipsis"><?= $row['last_name'] ?></span></td>
                                    <td><span class="ellipsis"><?= $row['company_name'] ?></span></td>
                                    <td><span class="ellipsis"><?= $row['email'] ?></span></td>
                                    <td><?= $row['regDate'] ?></td>
                                    <td>
