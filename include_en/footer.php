	...
	<div class="footer_wrap">
			<div class="footer_top">
				<div class="footer_inner">
					...
					<img src="<?=$cfg['baseUrl']?>/images/main/main_footer_img_01_en.png" alt="Guide to Singapore"/>
					<span class="guide_txt">Get the latest information for your successful business in Singapore.</span>
					<? if($isMain){?>
					<a href="<?=$cfg['baseUrl']?>/images/common/Guide_to_Doing_Business_in_Singpaore_Pearson_&_Partners.pdf" download class="down_btn">download</a>
					<?}else{?>
		...
		<div class="footer_wrap bottom">
			<div class="footer_bottom">
				<div class="footer_box1">
					<img src="<?=$cfg['baseUrl']?>/images/main/main_footer_img_11.png" alt="Pearson & Partners Logo"/>
					<span class="copy">
				...
				<div class="footer_box2">
					<a class="footer_box2_map" href="<?=$cfg['href']?>/contactus/"></a>
					<span class="add">Address : 77 Robinson Road, #34-01, Singapore 068896</span></span>
					<span class="add">TEL : +65 3129 0570</span>
					<span class="add">E-Mail : info@pearsonsingapore.com</span>
				</div>
				...
				<div class="footer_box4">
					...
					<span class="mail">Stay ahead with our latest insights.</span>
					<form method="post" action="<?=$cfg['href']?>/subscribe/" id="subscribeForm" autocomplete="off">
						<fieldset>
							<legend></legend>
