		...
		<div class="sub_box pb0">
	      ...
	      <div class="share-options">
	       ...
	       <a href="#" class="icon-close_large"><i class="far close"></i></a>
			 ...
			 <div class="file">
				<i class="downfile"></i><span class="ic">Attachments</span><a href="<?=$cfg['href']?>/board/board.download/?b=<?=$boardName?>&n=<?=$self['files'][3]['no']?>" target="_blank"><?=$self['files'][3]['realName']?></a>
			 </div>
			 <? } ?>
			</div>
		</div> <!--    sub_box end   -->
