<div class="sub_content_wrap">
	<div class="sub_content_box">
		<div class="sub_box">
			...
			<p class="sub_text ">Pearson & Partners offers a variety of resources for Singapore.</p>
				...
				<div class="downloadwrap">
					...
					<div class="box">
						...
						<div class="txtbox">
							...
							<a href="<?=$cfg['href']?>/download/?v=<?=$row['no']?>" target="_blank">download<i class="down"></i></a>
						</div>
					</div>
					<? } ?>
				</div>
