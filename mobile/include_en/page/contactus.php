			...
			<div class="sub_box">
				...
				<div class="whywrap contact pd0">
					...
					<div class="line">
						<div class="box">
							<p>address</p>
							<span>77 Robinson Road, #34-01, Singapore</span>
						</div>
						<div class="box">
							<p>tel</p>
		...
		<div class="full_sub_content_box ty03">
			<div class="sub_content_box ty02">
				<div class="whywrap contact">
					<p class="title ty03">Please fill out the form below.<br>We will get back to you as soon as we can.</p>
					<img src="<?=$cfg['baseUrl']?>/images/sub/inquiry_img1.png" alt="">
								...
								<form method="post" action="<?=$cfg['href']?>/contactus/" id="contactForm">
									...
									<div class="in_box_02">
										<div class="form_contents left">
											<div class="selectbox method_type ty84">
									...
									<div class="in_btns" >
										...
										<button type="submit"id="nextStep" class="form_btn btn_orange">Send</button>
									</div>
								</form>
							</div>
						</div>
