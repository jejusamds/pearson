		...
		<? } ?>
			...
			<nav>
				...
				<ul class="gnb">
					...
					<li class="<?=isActive("products")?>"><a href="<?=$cfg['href']?>/products/thesetupgenius">products</a>
						<ul class="depth2">
							<li class="<?=isActive("products/products_sub01")?>"><a href="<?=$cfg['href']?>/products/thesetupgenius">The Setup Genius<font class="color_text">™</font></a></li>
						</ul>
					</li>
