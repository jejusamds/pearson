	...
	<div class="inputwrap">
		...
		<div class="loca">
			<a href="<?=$cfg['href']?>/contactus/">
				<img src="<?=$cfg['baseUrl']?>/images/common/main_footer_map_mobile_sg_250123.png" alt="피어슨 앤 파트너스의 위치를 표시한 지도"/>
			</a>
			<span class="add">166, Apgujeong-ro, Gangnam-gu, Seoul, <br>
			Republic of Korea (06030)<br>
