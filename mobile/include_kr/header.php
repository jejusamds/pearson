...
<head>
	...
	<script>
		...
		})(window,document,'script','dataLayer','GTM-KND78P6Q');
	</script>
		...
		<? } ?>
			...
			<nav>
				...
				<ul class="gnb">
					...
					<li class="<?=isActive("products")?>"><a href="<?=$cfg['href']?>/products/singaporelaunchpad">products</a>
						<ul class="depth2">
							<li class="<?=isActive("products/products_sub01")?>"><a href="<?=$cfg['href']?>/products/singaporelaunchpad">싱가포르 런치패드™</a></li>
						</ul>
					</li>
