			...
			<div class="footer_bottom">
				...
				<div class="footer_box2">
					<a href="<?=$cfg['href']?>/contactus/">
						<img src="<?=$cfg['baseUrl']?>/images/main/main_footer_map_220614.png" alt="피어슨 앤 파트너스의 위치를 표시한 지도"/>
					</a>
					<span class="add">Address : 서울특별시 강남구 테헤란로 431<br/>
							  <span>저스트코타워</span></span>
