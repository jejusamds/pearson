		...
		<div class="footer_bottom">
			...
			<div class="footer_box2">
				<a href="<?=$cfg['href']?>/contactus/">
					<img src="<?=$cfg['baseUrl']?>/images/main/main_footer_map_250123.png" alt="피어슨 앤 파트너스의 위치를 표시한 지도"/>
				</a>
				<span class="add">Address : 서울특별시 강남구 압구정로 166<br/>
						  <span>리저스빌딩</span></span>
	...
	function go_download() {
		...
		$.ajax({
			...
			success: function(response) {
				...
				gtag('event', 'conversion', { 'send_to': 'AW-16712779570/sWYnCL7usbsaELKOo6E-' }); 
