	...
	<div class="sub_content_box">
		<div class="sub_box pb0">
	      ...
	      <div class="share-options">
	       ...
	       <a href="https://share.naver.com/web/shareView.nhn?url=<?=$shareURL?>&title=<?=urlencode($self['subject'])?>" target="_blank" class=" share-item share-enabled"><i class="far blog"></i></a>
	       ...
	       <a href="#" class="icon-close_large"><i class="far close"></i></a>
			 ...
			 <div class="file">
				<i class="downfile"></i><span class="ic">첨부파일</span><a href="<?=$cfg['href']?>/board/board.download/?b=<?=$boardName?>&n=<?=$self['files'][3]['no']?>"><?=$self['files'][3]['realName']?></a>
			 </div>
			 <? } ?>
			</div>
		</div> <!--    sub_box end   -->
						...
						<? for($i = 0; $i < count($latest); $i++){ ?>
							...
							<div class="box">
								<a href="<?=$cfg['href']?>/insights/<?=$row['permalink']?>/">
									<div class="img_wrap" style="background-image: url(<?=$row['files'][1]['originalSrc']?>)"></div>
									<div class="text_wrap">
										<h4><?=$row['subject']?></h4>
