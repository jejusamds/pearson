...
<div class="sub_content_wrap">
	<div class="sub_content_box">
		<div class="sub_box">
			...
			<p class="sub_title ty02">Insights</p>
			<p class="sub_text ty02">Perspectives on Singapore markets, businesses and its economy</p>
		</div> <!--    sub_box end   -->
		...
		<div class="sub_content_box ty02">
			<div class="contentwrap insightswrap">
				<ul class="insights_tab">
					<li class="<?=(($_GET['c'] == "") ? 'active' : '')?>"><a href="<?=$cfg['href']?><?=$pageDir?>">전체</a></li>
