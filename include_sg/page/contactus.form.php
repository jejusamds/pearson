				...
				<div class="in_box_02">
					<div class="form_contents left">
						<div class="selectbox method_type">
							...
							<? foreach($cfg['board']['category']['inquiry_sg'] as $key => $value){ ?>
...
<script>
	document.addEventListener('DOMContentLoaded', function() {
		// Submit 버튼이 있는 폼 찾기
		var submitButton = document.getElementById('nextStep');
		if(submitButton) {
			...
			if(form) {
				form.addEventListener('submit', function(event) {
					// 폼 제출 시 전환 추적 코드 실행
					gtag('event', 'conversion', { 'send_to': 'AW-318858636/DaroCP_0u_YZEIzLhZgB' }); 
				});
			}
		}
	});
